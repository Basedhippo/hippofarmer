 ...
 */
contract TRC721MetadataMintable is TRC721, MinterRole {
    /**
     ...
     */
    function mintWithTokenURI(address to, uint256 tokenId, string memory tokenURI) public virtual onlyMinter returns (bool) {
        _mint(to, tokenId);
...
contract TRC721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("RoidHippos", "ROIDHIPPOS") {
